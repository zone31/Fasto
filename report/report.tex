...
\subsection{Tests}
	...
	\item otherwise the optimized result is  \texttt{Times (e1', e2', pos)}.
	\end{itemize}
	...
	\item otherwise the optimized result is  \texttt{And (e1', e2', pos)}.
	\end{itemize}
	...
	\item otherwise the optimized result is  \texttt{Not (e1', pos)}.
	\end{itemize}
